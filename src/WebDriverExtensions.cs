...
{
    /// <summary>
    ///     An extension to safely get an element using the IWebDriver, by catching all of the exceptions that can be raised.
    ...
    public static IWebElement SafeGetElement(
        this IWebDriver driver,
        By by,
        int timeOutInSeconds = 0,
        Func<IWebElement, IWebElement> elementCheckFunc = null)
    {
        ...
        {
            DateTime timeToStop = DateTime.Now.AddSeconds(timeOutInSeconds);
            bool stop;
            do
            {
    ...
    /// <summary>
    ///     An extension to safely get elements using the IWebDriver, by catching all of the exceptions that can be raised.  If
    ///     the elements can't be found, and
    ...
    public static IReadOnlyCollection<IWebElement> SafeGetElements(
        this IWebDriver driver,
        By by,
        int timeOutInSeconds = 0)
    {
    ...
    /// <summary>
    ///     An extension to safely find an element using the IWebDriver, by catching all of the exceptions that can be raised.
    ///     If an element can't be found,
    ///     and the time out expires, then it will return null.
    /// </summary>
    /// <param name="driver"> The web driver set up in the calling application. </param>
    ...
    /// <summary>
    ///     An extension to safely find elements using the IWebDriver, by catching all of the exceptions that can be raised.
    ///     If the elements can't be found, and
    ///     the time out expires, this it will return null.
    /// </summary>
    /// <param name="driver"> The web driver set up in the calling application. </param>
    /// <param name="by"> The by search parameter set up in the calling application. </param>
    ...
    ///     A read only collection of IWebElements or null.
    /// </returns>
    public static IReadOnlyCollection<IWebElement> SafeFindElements(
        this IWebDriver driver,
        By by,
        int timeOutInSeconds = 0)
    {
    ...
    private static (IWebElement, bool) ProcessToFindElement(
        ...
        Func<IWebElement, IWebElement> elementCheckFunc = null)
    {
        ...
        try
        {
            IWebElement safeFind = driver.FindElement(by);
    ...
    private static (IReadOnlyCollection<IWebElement>, bool) ProcessFindElements(
        ISearchContext driver,
        By by)
    {
